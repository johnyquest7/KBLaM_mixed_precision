...
parser.add_argument("--hf_token", type=str,default="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",help="Huggingface token")
...
def get_prefix_str(args):
    ...
    if use_outlier:
        prefix_string += f"UseOutlier{outlier_num}"
